...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  valorant = {
     ...
     * @duplicate
     */
    v1PremierLeaderboardDetail3: (affinity: Affinities, conference: PremierConferences, division: number, params: RequestParams = {}) =>
      this.request<
        V1PremierLeaderboard,
        | {
            /** @example 400 */
     ...
     */
    v1WebsiteDetail: (countryCode: 'en-us' | 'en-gb' | 'de-de' | 'es-es' | 'es-mx' | 'fr-fr' | 'it-it' | 'ja-jp' | 'ko-kr' | 'pt-br' | 'ru-ru' | 'tr-tr' | 'vi-vn', params: RequestParams = {}) =>
      this.request<
        {
          /** @example 200 */
          status?: number
